...
public class ClickGui extends GuiScreen {
    ...
    public void drawScreen(int x, int y, float p) {
        ...
        if (!Gui.removeWatermark.isToggled()) {
            ...
            getFont().drawCenteredString("P", wd + 1 - w_c, h - 25, Utils.getChroma(2L, 1500L));
            getFont().drawCenteredString("e", wd - w_c, h - 15, Utils.getChroma(2L, 1200L));
            getFont().drawCenteredString("r", wd - w_c, h - 5, Utils.getChroma(2L, 900L));
            getFont().drawCenteredString("i", wd - w_c, h + 5, Utils.getChroma(2L, 600L));
            getFont().drawCenteredString("s", wd - w_c, h + 15, Utils.getChroma(2L, 300L));
            getFont().drawCenteredString("h", wd + 1 + w_c, h + 30, Utils.getChroma(2L, 0L));
