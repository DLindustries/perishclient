...
public class Utils {
    ...
    public static final ChatComponentText PREFIX = new ChatComponentText("&7[&dPerish client&7]&r ");
    ...
    public static void sendDebugMessage(String message) {
        if (nullCheck()) {
            mc.thePlayer.addChatMessage(new ChatComponentText("§7[§dPerish utils§7]§r " + message));
        }
    }
