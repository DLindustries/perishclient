...
public class Watermark extends Module {
    ...
    public static String customName = "get perish client at https://github.com/DLindustries/perishclient/releases/latest";
    ...
    public Watermark() {
        ...
        this.registerSetting(watermarkText = new ModeSetting("Watermark text", new String[]{"Default", "Custom", "FPS"}, 0, textMode));
        this.registerSetting(watermarkPhoto = new ModeSetting("Watermark photo", new String[]{"Default", "Enders", "akane"}, 0, photoMode));
        ...
        for (String s : Arrays.asList("default", "enders" ,"akane")) {
        ...
        switch ((int) mode.getInput()) {
            ...
            case 1:
                switch ((int) watermarkPhoto.getInput()) {
                    ...
                    case 2:
                        RenderUtils.drawImage(WATERMARK.get("akane"), posX, posY, 60, 60);
                }
                break;
        }
    }
